...
SERVICE_SECTIONS: list[tuple[str, list[str]]] = [
    (
        "ОКЛЕЙКА",
        [
...
# Плоский список оставляем для обратной совместимости.
SERVICES = [svc for _, section_services in SERVICE_SECTIONS for svc in section_services]
